...
public class ShellProxyDialog extends BaseAlertDialog {
    ...
    private void showSuggestSiteDialog() {
        ...
        new MaterialAlertDialogBuilder(requireActivity(), R.style.ThemeOverlay_XCTV_LightDialog).setTitle(R.string.setting_proxy_select_site).setItems(names, (dialog, which) -> suggestRules(sites.get(which))).show();
    }
